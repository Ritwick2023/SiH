      ...
      <div className="mt-5 space-y-4">
        {CURRICULUM_ERROR_POINTS.map((point) => {
          return (
            <div
              key={point.id}
              className="rounded-xl border border-[#D8DFEE] bg-[#EDF0F7]/40 p-4 hover:border-[#1C4CA1]/40 transition-all"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div className="space-y-1 flex-1 min-w-0">
                  ...
                  <h3 className="text-sm font-bold text-[#1F273A]">{point.topic}</h3>
                </div>
