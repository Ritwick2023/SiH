  ...
  return (
    <div className="relative w-full h-full min-h-135 lg:min-h-160 rounded-[28px] sm:rounded-4xl overflow-hidden shadow-2xl flex flex-col justify-between p-6 sm:p-8 select-none">
      ...
      <div className="relative z-10 flex items-start justify-between gap-3">
        ...
        <div className="bg-[#F8C858] text-[#2d1f17] rounded-2xl px-3.5 py-2 shadow-xl border border-white/40 flex items-center gap-2.5 max-w-65 animate-in fade-in slide-in-from-top-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] font-medium text-chart-5 mt-0.5">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <X className="h-4 w-4 text-chart-5 group-hover:rotate-90 transition-transform" />
          </button>
        </div>
      </div>
      ...
      <div className="relative z-10 flex justify-end pr-2 -my-2">
        <div className="flex flex-col -space-y-3 items-center">
          <div className="h-11 w-11 rounded-full border-2 border-white shadow-lg overflow-hidden bg-amber-100 flex items-center justify-center text-xs font-bold text-chart-5" title="Sunita Devi (NSSO FOD)">
            SD
          </div>
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-white/60 text-[#2d1f17] max-w-xs animate-in fade-in slide-in-from-bottom-2">
          ...
          <div className="flex items-center justify-between mt-3 pt-2 border-t border-slate-100">
            ...
            <div className="flex items-center -space-x-2">
              ...
              <div className="h-7 w-7 rounded-full bg-chart-5 text-white flex items-center justify-center text-[10px] font-bold border-2 border-white shadow-xs">
                RK
              </div>
            </div>
