    ...
    <div className="relative w-72 h-72 md:w-80 md:h-80 mx-auto">
      ...
      <svg viewBox="0 0 320 320" className="w-full h-full">
        ...
        {axes.map((axis, i) => {
          ...
          return (
            <g key={i}>
              <line x1={cx} y1={cy} x2={pt.x} y2={pt.y} stroke="rgba(28,76,161,0.25)" strokeWidth="1" />
        ...
        <path d={buildPath(targetValues)} fill="rgba(28,76,161,0.08)" stroke="rgba(28,76,161,0.4)" strokeWidth="1.5" strokeDasharray="4 3" />
        <path
          d={buildPath(animated ? currentValues : currentValues.map(() => 0))}
          fill="rgba(28,76,161,0.25)"
          stroke="#1C4CA1"
          strokeWidth="2.5"
        ...
        {axes.map((axis, i) => {
          ...
          return (
            <circle key={i} cx={pt.x} cy={pt.y} r="4.5" fill="#1C4CA1" stroke="white" strokeWidth="2"
...
export function AnimatedProgressBar({ label, value, maxValue = 5, color = '#1C4CA1', delay = 0 }: ProgressBarProps) {
